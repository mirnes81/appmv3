    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-6">
          ...
          <h2 className="text-3xl font-bold text-gray-800">Gestion du Matériel</h2>
        </div>

        <div className="bg-white rounded-xl shadow p-6 mb-6">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-xl font-semibold text-gray-800">Liste du matériel</h3>
          ...
          <div className="text-center py-12 text-gray-500">
            ...
            <p className="text-lg">Aucun matériel enregistré</p>
            <p className="text-sm mt-2">Ajoutez votre premier équipement</p>
          </div>
        </div>
      </main>
    </div>
